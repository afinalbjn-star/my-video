  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1, textShadow: '0 0 20px currentColor' }}>
        A futuristic neural network visualization with glowing nodes and connections
      </div>
