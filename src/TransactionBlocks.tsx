  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1, textShadow: '0 0 20px currentColor' }}>
        A futuristic visualization of a blockchain network, showcasing transaction blocks and hash chains in a seamless, high-speed loop
      </div>
